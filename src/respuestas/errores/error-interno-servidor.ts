...
export const objErrorInternoServidor = (externo: number, mensaje: string): IOpcionesErrorInternoServidor => ({
  ...
  desconocido: (detalles: DetallesEntrada, errorInterno?: number, apiName?: string, transformador?: ITransformador) => new ErrorApi(externo, errorInterno || 1000, mensaje, detalles, apiName || AbstractConfiguration.API_NOMBRE, transformador),
  bd: (detalles: DetallesEntrada, errorInterno?: number, apiName?: string, transformador?: ITransformador) => new ErrorApi(externo, errorInterno || 1001, mensaje, detalles, apiName || AbstractConfiguration.API_NOMBRE, transformador),
