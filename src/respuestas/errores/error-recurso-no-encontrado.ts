...
export const objErrorRecursoNoEncontrado = (externo: number, mensaje: string): IOpcionesErrorRecursoNoEncontrado => ({
  ...
  rutaNoValida: (detalles: DetallesEntrada, codigoInterno?: number, apiName?: string, transformador?: ITransformador) => new ErrorApi(externo, codigoInterno || 1001, mensaje, detalles, apiName || AbstractConfiguration.API_NOMBRE, transformador),
  recursoNoEncontrado: (detalles: DetallesEntrada, codigoInterno?: number, apiName?: string, transformador?: ITransformador) => new ErrorApi(externo, codigoInterno || 1002, mensaje, detalles, apiName || AbstractConfiguration.API_NOMBRE, transformador),
  recursoBDNoEncontrado: (detalles: DetallesEntrada, codigoInterno?: number, apiName?: string, transformador?: ITransformador) => new ErrorApi(externo, codigoInterno || 1003, mensaje, detalles, apiName || AbstractConfiguration.API_NOMBRE, transformador),
